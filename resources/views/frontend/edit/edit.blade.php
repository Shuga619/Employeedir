            ...
            <h2>Edit {{ $record->name }}'s Information</h2>
              ...
              <div class="social-icons">
                ...
                <h3>
                  ...
                  New Department : <select class="lg-input">
                    <option selected="selected">Select your new Department</option>
                ...
                <h3>Mobile Number : <input type="text" name="extension" value="{{ $record->contact->mobile }}" class="lg-input"></h3>
                <br>
                <a href="#" class="mb-3">
                ...
                <h3>Flexcube User ID : <span class="text-bnb-blue no-case"> <input type="text" name="extension" value="{{ $record->contact->flexcube }}" class="lg-input"></span></h3>
                ...
                <h3>New Location : <select class="lg-input">
                    <option selected="selected">Select your new office Location</option>
                ...
                <hr>
                <div class="btn-group">
                  <button class="btn btn-lg bg-bnb-blue text-white"><i class="fas fa-save"></i> Save Information and Exit</button>
                  <button class="btn btn-lg bg-bnb-orange text-white"><i class="fas fa-sign-out-alt"></i> Exit Without Saving</button>
                </div>
              </div>
