...
<head>
    ...
    <title>Admin | BNBL Employee Directory</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon ">
                    <img src="{{asset('images/directory-sm.png')}}">
                </div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('index_path') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('directory_path') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('add_contact_path')}}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="#">
                                    <i class="fas fa-user-plus fa-fw fa-sm fa-fw mr-2 text-gray-400"></i>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright <i class="far fa-copyright"></i> Bhutan National Bank Limited</span>
                    </div>
                </div>
            </footer>
          <!-- End of Footer -->
